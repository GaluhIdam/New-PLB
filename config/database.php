    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', '172.16.41.139'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'db_plb'),
        ...
        'db_plbGmf' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_PLBGMF_HOST', '172.16.41.139'),
            'port' => env('DB_PLBGMF_PORT', '3306'),
            'database' => env('DB_PLBGMF_DATABASE', 'db_plbGmf'),
            'username' => env('DB_PLBGMF_USERNAME', 'developer'),
        ...
        'plb_db_prod' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_PLB_HOST', '172.16.41.139'),
            'port' => env('DB_PLB_PORT', '3306'),
            'database' => env('DB_PLB_DATABASE', 'plb_db_prod'),
            'username' => env('DB_PLB_USERNAME', 'developer'),
        ...
        'iplb_db_prod' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_IPLB_HOST', '172.16.41.139'),
            'port' => env('DB_IPLB_PORT', '3306'),
            'database' => env('DB_IPLB_DATABASE', 'iplb_db_prod'),
            'username' => env('DB_IPLB_USERNAME', 'developer'),

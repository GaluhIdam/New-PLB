    ...
    */
    ...
    'connections' => [
        ...
        'plb_db_prod' => [
            ...
            'host' => env('DB_PROD_HOST', '192.168.40.80'),
            'port' => env('DB_PROD_PORT', '3306'),
            'database' => env('DB_PROD_DATABASE', 'plb_db_prod'),
            'username' => env('DB_PROD_USERNAME', 'usr-jti'),
            'password' => env('DB_PROD_PASSWORD', 'aeroasia'),
        ...
        'plb_db_archive10' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE10_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE10_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive11' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE11_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE11_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive12' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE12_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE12_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive13' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE13_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE13_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive14' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE14_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE14_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive15' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE15_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE15_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive16' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE16_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE16_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive17' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE17_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE17_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive18' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE18_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE18_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive19' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE19_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE19_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'plb_db_archive20' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ARCHIVE20_HOST', '192.168.40.80'),
            ...
            'password' => env('DB_ARCHIVE20_PASSWORD', 'aeroasia'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',

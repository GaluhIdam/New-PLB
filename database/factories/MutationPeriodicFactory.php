...
class MutationPeriodicFactory extends Factory
{
    ...
    {
        return [
            'registration_date' => $this->faker->unique()->dateTimeBetween('-3 years', 'now'),
            'registration_number' => $this->faker->randomNumber(6, true),
            'submission_number' => $this->faker->numerify('03900#####'),
            'submission_date' => $this->faker->unique()->dateTimeBetween('-3 years', 'now'),
            ...
            'code_bc_27_out' => $this->faker->randomFloat(2, 0, 100),
            'code_bc_28_in' => $this->faker->randomFloat(2, 0, 100),
            'code_bc_28_out' => $this->faker->randomFloat(2, 0, 100),
            'code_bc_30_in' => $this->faker->randomFloat(2, 0, 100),
            'code_bc_30_out' => $this->faker->randomFloat(2, 0, 100),
            'code_bc_40_in' => $this->faker->randomFloat(2, 0, 100),
            'code_bc_40_out' => $this->faker->randomFloat(2, 0, 100),
            'code_bc_41_in' => $this->faker->randomFloat(2, 0, 100),

									...
									<div class="vgt-wrap polar-bear">
										<div class="vgt-inner-wrap">
											...
											<div class="vgt-responsive">
												<table id="vgt-table" class="vgt-table bordered polar-bear clearfix">
													<thead>
														<tr>
															<!-- Jenis Dokumen -->
															...
															<!-- Tanggal Pengeluaran -->
															<th v-if="order == 'date_outbound' && by == 'asc'"
															...
															<th v-else-if="order == 'date_outbound' && by == 'desc'"
																@click="sort('id', 'asc')"
																class="text-center sortable sorting sorting-desc">
																<span class="table_header">Tanggal Pengeluaran</span>
																<button>
															...
															<th v-else @click="sort('date_outbound', 'asc')"
																class="text-center sortable">
																<span class="table_header">Tanggal Pengeluaran</span>
																<button>
																	<span class="sr-only"></span>
															...
															<th v-if="order == 'owner' && by == 'asc'"
																...
																class="text-center sortable sorting sorting-asc">
																<span class="table_header">Nama Penerima/Pemilik</span>
																<button>
																	<span class="sr-only"></span>
																</button>
															</th>
														...
														<tr>
															...
															<th class="filter-th">
																<div>
																	<input type="text" class="vgt-input"
																		placeholder="Filter Nama Pengirim/Pemilik"
													...
													<tbody>
														<tr v-for="(outbound, outbound_index) in outbounds.data"
															:key="outbound_index">
															...
															<td class="table_content">{{ outbound.date_register }}</td>
															<td class="table_content">{{ outbound.date_outbound }}</td>

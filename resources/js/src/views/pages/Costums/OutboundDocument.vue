                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                        <label class="control-label" style="margin-top: 5px">
                          <input type="checkbox" value="28" v-model="filter_document_type" />
                          28
                        </label>
                      </div>
                      <div class="col-sm-2">
                        <label class="control-label" style="margin-top: 5px">
                          <input type="checkbox" value="30" v-model="filter_document_type" />
                          30
                        </label>
                      </div>
                      <div class="col-sm-2">
                        <label class="control-label" style="margin-top: 5px">
                          <input type="checkbox" value="41" v-model="filter_document_type" />
                          41
                        </label>
                      </div>
                    </div>
                        ...
                        <table id="vgt-table" class="vgt-table bordered polar-bear">
                          <thead>
                            <tr>
                              ...
                              <!-- Tanggal Pengeluaran-->
                              <th v-if="order == 'date_outbound' && by == 'asc'" @click="sort('date_outbound', 'desc')" class="text-center sortable sorting sorting-asc">
                                <span class="table_header">Tanggal Pengeluaran</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              </th>
                              <th v-else-if="order == 'date_outbound' && by == 'desc'" @click="sort('id', 'asc')" class="text-center sortable sorting sorting-desc">
                                <span class="table_header">Tanggal Pengeluaran</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              </th>
                              <th v-else @click="sort('date_outbound', 'asc')" class="text-center sortable">
                                <span class="table_header">Tanggal Pengeluaran</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                            ...
                            <tr>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="date" class="vgt-input" placeholder="Filter Tanggal Pengeluaran" v-model="search_date_outbound" />
                                </div>
                              </th>
                              <th class="filter-th">
                                <div>
                          ...
                          <tbody>
                            <tr v-for="(outbound, outbound_index) in outbounds.data" :key="outbound_index">
                              <td class="table_content">{{ outbound.document_type }}</td>
                              <td class="table_content">{{ outbound.no_aju }}</td>
                              <td class="table_content">{{ outbound.date_aju }}</td>
                              <td class="table_content">{{ outbound.no_register }}</td>
                              <td class="text-center table_content">{{ outbound.date_register | formatDate }}</td>
                              <td class="text-center table_content">{{ outbound.date_outbound | formatDate }}</td>

                              <td class="table_content">{{ outbound.owner }}</td>
                              <td class="table_content">{{ outbound.item_code }}</td>
                              <td class="table_content">{{ outbound.hs_code }}</td>
                              <td class="table_content">{{ outbound.item_name }}</td>
                              <td class="table_content">{{ outbound.quantity }}</td>
                              <td class="table_content">{{ outbound.unit }}</td>
                              <td class="table_content">{{ outbound.item_value }}</td>
                              <td class="table_content">{{ outbound.attachment }}</td>
                            </tr>
                      ...
                      <div class="vgt-wrap__footer vgt-clearfix">
                        ...
                        <div class="footer__navigation vgt-pull-right">
                          <button
                            ...
                            @click="outbounds.prev_page_url && list(outbounds.prev_page_url)"
                          ...
                          <button
                            ...
                            @click="outbounds.next_page_url && list(outbounds.next_page_url)"
                          >

                        ...
                        >
                          <thead>
                            <tr>
                              ...
                              <!-- Tanggal Pemasukan -->
                              <th
                                v-if="order == 'date_inbound' && by == 'asc'"
                              ...
                              <th
                                v-else-if="order == 'sender' && by == 'desc'"
                                @click="sort('id', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                              >
                                <span class="table_header">Nama Pengirim</span>

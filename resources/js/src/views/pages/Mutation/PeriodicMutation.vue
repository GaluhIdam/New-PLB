              ...
              <div class="card-body">
                <form @submit.prevent class="form-horizontal">
                  <div class="form-group row justify-content-center align-items-center mt-4">
                    ...
                    <div class="col-sm-3">
                      <datepicker input-class="form-control" placeholder="Dari Tanggal" format="MM/dd/yyyy" v-model="start_date" />
                    </div>
                    <div class="col-sm-3">
                      <datepicker input-class="form-control" placeholder="Sampai Tanggal" format="MM/dd/yyyy" v-model="end_date" />
                    </div>
                    <div class="col-sm-10 mt-4 text-center">
                      <button class="btn btn-primary" @click="filterDate"><i class="fa-solid fa-magnifying-glass"></i> Filter</button>
                    ...
                    <div class="vgt-inner-wrap">
                      ...
                      <div class="vgt-responsive">
                        <table id="vgt-table" class="vgt-table bordered polar-bear">
                          ...
                          <!-- BEGIN: Table Body -->
                          <tbody>
                            <tr v-for="(mutation_periodic, mutation_periodic_index) in mutation_periodics.data" :key="mutation_periodic_index">
                      ...
                      <div class="vgt-wrap__footer vgt-clearfix">
                        ...
                        <div class="footer__navigation vgt-pull-right">
                          <button
                            ...
                            @click="mutation_periodics.prev_page_url && list(mutation_periodics.prev_page_url)"
                          ...
                          <button
                            ...
                            @click="mutation_periodics.next_page_url && list(mutation_periodics.next_page_url)"
                          >

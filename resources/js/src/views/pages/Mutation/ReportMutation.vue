                  ...
                  <div class="col-md-8">
                    <form @submit.prevent class="form-horizontal" enctype="multipart/form-data">
                      <div class="form-group row mt-4">
                        <label class="col-sm-3 col-form-label">Tanggal Mutasi</label>
                        <div class="col-sm-4">
                          <datepicker input-class="form-control" placeholder="Dari Tanggal" format="MM/dd/yyyy"
                            v-model="filter_start_date" />
                        </div>
                        <div class="col-sm-4">
                          <datepicker input-class="form-control" placeholder="Sampai Tanggal" format="MM/dd/yyyy"
                        ...
                        <table id="vgt-table" class="vgt-table bordered polar-bear">
                          <thead>
                            <tr>
                              ...
                              <th rowspan="2" v-if="order == 'KODE_BARANG' && by == 'asc'"
                                @click="sort('KODE_BARANG', 'desc')" class="text-center sortable sorting sorting-asc">
                                <span class="table_header">Kode Barang</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              </th>
                              <th rowspan="2" v-else-if="
                                order == 'KODE_BARANG' && by == 'desc'
                              " @click="sort('TANGGAL_SALDO', 'asc')"
                              ...
                              <th rowspan="2" v-else @click="sort('KODE_BARANG', 'asc')" class="text-center sortable">
                                <span class="table_header">Kode Barang</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th rowspan="2" v-if="order == 'URAIAN' && by == 'asc'" @click="sort('URAIAN', 'desc')"
                                class="text-center sortable sorting sorting-asc">
                              ...
                              <th rowspan="2" v-else-if="order == 'URAIAN' && by == 'desc'"
                                @click="sort('TANGGAL_SALDO', 'asc')" class="text-center sortable sorting sorting-desc">
                                <span class="table_header">Nama Barang</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              </th>
                              <th rowspan="2" v-else @click="sort('URAIAN', 'asc')" class="text-center sortable">
                                <span class="table_header">Nama Barang</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th rowspan="2" v-if="order == 'KODE_SATUAN' && by == 'asc'"
                                @click="sort('KODE_SATUAN', 'desc')" class="text-center sortable sorting sorting-asc">
                              ...
                              <th rowspan="2" v-else @click="sort('KODE_SATUAN', 'asc')" class="text-center sortable">
                                <span class="table_header">Satuan</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th rowspan="2" v-if="order == 'SALDO_AWAL' && by == 'asc'"
                                @click="sort('SALDO_AWAL', 'desc')" class="text-center sortable sorting sorting-asc">
                              ...
                              <th rowspan="2" v-else @click="sort('SALDO_AWAL', 'asc')" class="text-center sortable">
                                <span class="table_header">Saldo Awal</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th rowspan="2" v-if="order == 'SALDO_AKHIR' && by == 'asc'"
                                @click="sort('SALDO_AKHIR', 'desc')" class="text-center sortable sorting sorting-asc">
                              ...
                              <th rowspan="2" v-else @click="sort('SALDO_AKHIR', 'asc')" class="text-center sortable">
                                <span class="table_header">Saldo Akhir</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                            ...
                            <tr>
                              ...
                              <th v-if="order == 'BC16' && by == 'asc'" @click="sort('BC16', 'desc')"
                                class="text-center sortable sorting sorting-asc">
                              ...
                              <th v-else-if="order == 'BC16' && by == 'desc'" @click="sort('TANGGAL_SALDO', 'asc')"
                                class="text-center sortable sorting sorting-desc">
                                <span class="table_header">BC 1.6</span>
                                <button>
                                  <span class="sr-only"></span>
                              ...
                              <th v-else @click="sort('BC16', 'asc')" class="text-center sortable">
                                <span class="table_header">BC 1.6</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th v-if="order == 'BC27IN' && by == 'asc'" @click="sort('BC27IN', 'desc')"
                                class="text-center sortable sorting sorting-asc">
                              ...
                              <th v-else-if="order == 'BC27IN' && by == 'desc'" @click="sort('TANGGAL_SALDO', 'asc')"
                                class="text-center sortable sorting sorting-desc">
                                <span class="table_header">BC 2.7</span>
                                <button>
                                  <span class="sr-only"></span>
                              ...
                              <th v-else @click="sort('BC27IN', 'asc')" class="text-center sortable">
                                <span class="table_header">BC 2.7</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th v-if="order == 'BC40' && by == 'asc'" @click="sort('BC40', 'desc')"
                                class="text-center sortable sorting sorting-asc">
                              ...
                              <th v-else-if="order == 'BC40' && by == 'desc'" @click="sort('TANGGAL_SALDO', 'asc')"
                                class="text-center sortable sorting sorting-desc">
                                <span class="table_header">BC 4.0</span>
                                <button>
                                  <span class="sr-only"></span>
                              ...
                              <th v-else @click="sort('BC40', 'asc')" class="text-center sortable">
                                <span class="table_header">BC 4.0</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th v-if="order == 'BC27' && by == 'asc'" @click="sort('BC27', 'desc')"
                                class="text-center sortable sorting sorting-asc">
                                <span class="table_header">BC 2.7</span>
                                <button>
                                  <span class="sr-only"></span>
                              ...
                              <th v-else-if="order == 'BC27' && by == 'desc'" @click="sort('TANGGAL_SALDO', 'asc')"
                                class="text-center sortable sorting sorting-desc">
                                <span class="table_header">BC 2.7</span>
                                <button>
                                  <span class="sr-only"></span>
                              ...
                              <th v-else @click="sort('BC27', 'asc')" class="text-center sortable">
                                <span class="table_header">BC 2.7</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th v-if="order == 'BC28' && by == 'asc'" @click="sort('BC28', 'desc')"
                                class="text-center sortable sorting sorting-asc">
                              ...
                              <th v-else-if="order == 'BC28' && by == 'desc'" @click="sort('TANGGAL_SALDO', 'asc')"
                                class="text-center sortable sorting sorting-desc">
                                <span class="table_header">BC 2.8</span>
                                <button>
                                  <span class="sr-only"></span>
                              ...
                              <th v-else @click="sort('BC28', 'asc')" class="text-center sortable">
                                <span class="table_header">BC 2.8</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th v-if="order == 'BC30' && by == 'asc'" @click="sort('BC30', 'desc')"
                                class="text-center sortable sorting sorting-asc">
                              ...
                              <th v-else-if="order == 'BC30' && by == 'desc'" @click="sort('TANGGAL_SALDO', 'asc')"
                                class="text-center sortable sorting sorting-desc">
                                <span class="table_header">BC 3.0</span>
                                <button>
                                  <span class="sr-only"></span>
                              ...
                              <th v-else @click="sort('BC30', 'asc')" class="text-center sortable">
                                <span class="table_header">BC 3.0</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th v-if="order == 'BC41' && by == 'asc'" @click="sort('BC41', 'desc')"
                                class="text-center sortable sorting sorting-asc">
                              ...
                              <th v-else-if="order == 'BC41' && by == 'desc'" @click="sort('TANGGAL_SALDO', 'asc')"
                                class="text-center sortable sorting sorting-desc">
                                <span class="table_header">BC 4.1</span>
                                <button>
                                  <span class="sr-only"></span>
                              ...
                              <th v-else @click="sort('BC41', 'asc')" class="text-center sortable">
                                <span class="table_header">BC 4.1</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                            ...
                            <tr>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="Kode Barang"
                                    v-model="search_kode_barang" @change="list()" />
                                </div>
                              </th>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="Nama Barang"
                                    v-model="search_nama_barang" @change="list()" />
                                </div>
                              </th>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="Kode"
                                    v-model="search_kode_satuan" @change="list()" />
                                </div>
                              </th>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="Awal"
                                    v-model="search_saldo_awal" @change="list()" />
                                </div>
                              </th>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="1.6"
                                    v-model="search_bc16" @change="list()" />
                                </div>
                              </th>
                              <!-- END: Filter BC 1.6 -->
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="2.7 IN"
                                    v-model="search_bc27_in" @change="list()" />
                                </div>
                              </th>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="4.0"
                                    v-model="search_bc40" @change="list()" />
                                </div>
                              </th>
                              <!-- END: Filter BC 4.0 -->
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="2.7 OUT"
                                    v-model="search_bc27_out" @change="list()" />
                                </div>
                              </th>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="2.8"
                                    v-model="search_bc28" @change="list()" />
                                </div>
                              </th>
                              <!-- END: Filter BC 2.8 -->
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="3.0"
                                    v-model="search_bc30" @change="list()" />
                                </div>
                              </th>
                              <!-- END: Filter BC 3.0 -->
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="4.1"
                                    v-model="search_bc41" @change="list()" />
                                </div>
                              </th>
                              <!-- END: Filter BC 4.1 -->
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="text" class="vgt-input text-center" placeholder="Akhir"
                                    v-model="search_saldo_akhir" @change="list()" />
                                </div>
                              </th>
                          ...
                          <tbody>
                            <!-- BEGIN: Table Content -->
                            <tr v-for="(report, report_index) in reports.data" :key="report_index">
                              <!-- BEGIN: Content No -->
                              ...
                              <td class="text-center table_content">
                                {{
                                    parseFloat(report.SALDO_AWAL) + parseFloat(report.BC16) + parseFloat(report.BC27IN) +
                                    parseFloat(report.BC40) -
                                    parseFloat(report.BC27OUT) - parseFloat(report.BC28) - parseFloat(report.BC30) -
                                    parseFloat(report.BC41) | formatMutation
                                }}
                              </td>
                              ...
                              <td class="text-center table_content">
                                {{
                                    report.SALDO_AKHIR | formatMutation
                                }}
                              </td>
                              ...
                              <td class="text-center table_content">
                                {{
                                    parseFloat(report.SALDO_AKHIR) - parseFloat(report.SALDO_AWAL) + parseFloat(report.BC16)
                                    + parseFloat(report.BC27IN) +
                                    parseFloat(report.BC40) -
                                    parseFloat(report.BC27OUT) - parseFloat(report.BC28) - parseFloat(report.BC30) -
                                    parseFloat(report.BC41) | formatMutation
                                }}
  ...
  methods: {
    ...
    exportCsv() {
      ...
      axios
        ...
        .then((response) => {
          ...
          link.href = url;
          link.setAttribute("download", "report-mutation.csv");
    ...
    exportExcel() {
      ...
      axios
        ...
        .then((response) => {
          ...
          const link = document.createElement("a");
          link.href = url;
          link.setAttribute("download", "report-mutation.xlsx");
          document.body.appendChild(link);
          link.click();
          Swal.close();
          this.showSuccessExport();
    ...
    showSuccessRequest() {
      Swal.fire({
        ...
        position: 'top-end',
        icon: 'success',
        title: 'Successfully Retrive Data',
    ...
    directPage: debounce(function () {
      ...
      let url = new URL(this.reports.first_page_url);

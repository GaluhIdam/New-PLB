                        ...
                        <table id="vgt-table" class="vgt-table bordered polar-bear">
                          <thead>
                            <tr>
                              ...
                              <!-- TTD Date -->
                              <th v-if="order == 'date_bc_out' && by == 'asc'" @click="sort('date_bc_out', 'desc')" class="text-center sortable sorting sorting-asc">
                                <span class="table_header">TTD Date</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              </th>
                              <th v-else-if="order == 'date_bc_out' && by == 'desc'" @click="sort('id', 'asc')" class="text-center sortable sorting sorting-desc">
                                <span class="table_header">TTD Date</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              </th>
                              <th v-else @click="sort('date_bc_out', 'asc')" class="text-center sortable">
                                <span class="table_header">TTD Date</span>
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                            ...
                            <tr>
                              ...
                              <th class="filter-th">
                                <div>
                                  <input type="date" class="vgt-input" placeholder="Filter TTD Date" v-model="search_date_bc_out" />
                                </div>
                              </th>
                              <th class="filter-th">
                                <div>
                          ...
                          <tbody>
                            <tr v-for="(transaction, transaction_index) in transactions.data" :key="transaction_index">
                              ...
                              <td class="table_content">{{ transaction.date_bc_out | formatDate }}</td>

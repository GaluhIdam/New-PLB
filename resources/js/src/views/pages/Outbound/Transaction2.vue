          ...
          <div class="col-md-12">
            <div class="card card-plb">
                        ...
                        >
                          ...
                          <tbody>
                            ...
                            >
                              ...
                              <td class="table_content">
                                {{ transaction.date_bc_out | formatDate }}
                              </td>
                              <td class="table_content">
                                {{ transaction.cif_idr }}
                              </td>
              ...
              <div class="card-footer text-center" v-if="filter_clicked">
                Status Pesawat Sudah diluar Area PLB GMF
              </div>
            </div>
          </div>
        </div>

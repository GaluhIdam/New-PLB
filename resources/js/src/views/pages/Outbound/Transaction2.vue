    ...
    <div>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0">Transaksi Outbound 2</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <span>Transaksi Outbound 2​</span>
                            </li>
                        </ol>
                    </div>
                </div>
                                            ...
                                            <div class="vgt-responsive">
                                                <table id="vgt-table" class="vgt-table bordered polar-bear">
                                                    <thead>
                                                        <tr>
                                                            <!-- Part Number -->
                                                            <th v-if="order == 'part_number' && by == 'asc'"
                                                            ...
                                                            <th v-else-if="order == 'part_number' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                            ...
                                                            <th v-else @click="sort('part_number', 'asc')"
                                                            ...
                                                            <!-- Description -->
                                                            <th v-if="order == 'description' && by == 'asc'"
                                                            ...
                                                            <th v-else-if="order == 'description' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">Description</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('description', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">Description</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <!--  Kode Satuan -->
                                                            <th v-if="order == 'unit_code' && by == 'asc'"
                                                            ...
                                                            <th v-else-if="order == 'unit_code' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">Kode Satuan</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('unit_code', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">Kode Satuan</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <!-- Register A/C -->
                                                            <th v-if="order == 'register_ac' && by == 'asc'"
                                                            ...
                                                            <th v-else-if="order == 'register_ac' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">Register A/C</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('register_ac', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">Register A/C</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <th v-else-if="order == 'customer' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">Customer</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('customer', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">Customer</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <th v-if="order == 'date_install' && by == 'asc'"
                                                            ...
                                                            <th v-else-if="order == 'date_install' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">Date Install/Consume</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('date_install', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">Date Install/Consume</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <!-- Date A/C In -->
                                                            <th v-if="order == 'date_ac_in' && by == 'asc'"
                                                            ...
                                                            <th v-else-if="order == 'date_ac_in' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">Date A/C In</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('date_ac_in', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">Date A/C In</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <!-- Date A/C Out -->
                                                            <th v-if="order == 'date_ac_out' && by == 'asc'"
                                                            ...
                                                            <th v-else-if="order == 'date_ac_out' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">Date A/C Out</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('date_ac_out', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">Date A/C Out</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <!-- Type BC Out -->
                                                            <th v-if="order == 'type_bc_out' && by == 'asc'"
                                                            ...
                                                            <th v-else-if="order == 'type_bc_out' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">Type BC Out</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('type_bc_out', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">Type BC Out</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <!-- TTD Date -->
                                                            <th v-if="order == 'date_bc_out' && by == 'asc'"
                                                                @click="sort('date_bc_out', 'desc')"
                                                                class="text-center sortable sorting sorting-asc">
                                                            ...
                                                            <th v-else-if="order == 'date_bc_out' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">TTD Date</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('date_bc_out', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">TTD Date</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <th v-else-if="order == 'cif_idr' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">CIF IDR</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('cif_idr', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">CIF IDR</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <th v-else-if="order == 'bm_paid' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">BM Dibayar</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('bm_paid', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">BM Dibayar</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <th v-else-if="order == 'ppn_paid' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">PPN Dibayar</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('ppn_paid', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">PPN Dibayar</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                            ...
                                                            <th v-else-if="order == 'pph_paid' && by == 'desc'"
                                                                @click="sort('id', 'asc')"
                                                                class="text-center sortable sorting sorting-desc">
                                                                <span class="table_header">PPh Dibayar</span>
                                                                <button>
                                                            ...
                                                            <th v-else @click="sort('pph_paid', 'asc')"
                                                                class="text-center sortable">
                                                                <span class="table_header">PPh Dibayar</span>
                                                                <button>
                                                                    <span class="sr-only"></span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="filter-th">
                                                                <div>
                                                                    <input type="date" class="vgt-input"
                                                                        placeholder="Filter TTD Date"
                                                                        v-model="search_date_bc_out" />
                                                                </div>
                                                            </th>
                                                            <th class="filter-th">
                                                                <div>
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(transaction, transaction_index) in transactions.data"
                                                            ...
                                                            <td class="table_content">{{ transaction.date_install |
                                                                    formatDate
                                                            }}</td>
                                                            <td class="table_content">{{ transaction.date_ac_in |
                                                                    formatDate
                                                            }}</td>
                                                            <td class="table_content">{{ transaction.date_ac_out |
                                                                    formatDate
                                                            }}</td>
                                                            <td class="table_content">{{ transaction.type_bc_out }}</td>
                                                            <td class="table_content">{{ transaction.no_aju }}</td>
                                                            <td class="table_content">{{ transaction.date_bc_out |
                                                                    formatDate
                                                            }}</td>
...
export default {
    data() {
        return {
            ...
            // search_date_ac_out: null,
            // search_type_bc_out: null,
            // search_no_aju: null,
            // search_date_bc_out: null,
            // search_cif_idr: null,
            // search_bm_paid: null,
            ...
            axios
                .get(paginate, {
                    params: {
                        ...
                        // search_date_ac_out: this.search_date_ac_out,
                        // search_type_bc_out: this.search_type_bc_out,
                        // search_no_aju: this.search_no_aju,
                        // search_date_bc_out: this.search_date_bc_out,
                        // search_cif_idr: thissearch_cif_idr.,
                        // search_bm_paid: this.search_bm_paid,
                        // search_ppn_paid: this.search_ppn_paid,
                        // search_pph_paid: this.search_pph_paid,

												...
												<table id="vgt-table" class="vgt-table bordered polar-bear">
													<thead>
														<tr>
															...
															<!-- Kondisi -->
															<th v-if="order == 'condition' && by == 'asc'"
															...
															<th v-else-if="order == 'condition' && by == 'desc'"
																@click="sort('id', 'asc')"
																class="text-center sortable sorting sorting-desc">
																<span class="table_header">Kondisi</span>
																<button>
															...
															<th v-else @click="sort('condition', 'asc')"
																class="text-center sortable">
																<span class="table_header">Kondisi</span>
																<button>
																	<span class="sr-only"></span>
													...
													<tbody>
														<tr v-for="(transaction, transaction_index) in transactions.data"
															...
															<td class="table_content">{{ transaction.ppn_not_paid }}
															</td>
															<td class="table_content">{{ transaction.pph_not_paid }}
															</td>
														</tr>

                      ...
                      <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                        <thead>
                          <tr>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Ip.Address: activate to sort column ascending">Activity</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr class="odd">
                            ...
                            <td>tmb_gmf</td>
                            <td>2018-09-17 11:25:21</td>
                            <td>Akses Pemasukan Barang</td>
                          </tr>
                          <tr class="even">
                            <td class="dtr-control sorting_1" tabindex="0">2</td>
                            <td>tgo_gmf</td>
                            <td>2018-09-17 11:25:48 ​</td>
                            <td>Akses Pemasukan Barang</td>
                          </tr>
                          <tr class="even">
                            <td class="dtr-control sorting_1" tabindex="0">2</td>

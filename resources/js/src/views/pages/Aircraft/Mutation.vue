  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Mutasi Pesawat tes</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
              <li class="breadcrumb-item active"><a href="/mutation">Mutasi Pesawat</a></li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr v-for="( mutation, mutation_index ) in mutations.data" :key="mutation_index">
                        ...
                        <td>
                          <a v-if="mutation.rksp != null" :href="`/storage/${mutation.rksp}`" target="_blank" rel="noopener noreferrer">
                            RKSP
                          </a>
                        </td>

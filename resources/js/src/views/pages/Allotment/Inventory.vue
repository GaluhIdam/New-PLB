        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><span>Inventory Allotment</span></li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label for="part_number" class="col-sm-4 col-form-label text-center">Plant</label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <button class="btn btn-primary btn-md" @click="filter"><i
                            class="fa-solid fa-magnifying-glass"></i>Search</button>
                        <button class="btn btn-secondary btn-md" @click="reset"><i
                            ...
                            <table id="vgt-table" class="vgt-table bordered polar-bear">
                              <thead>
                                <tr>
                                  ...
                                  <th v-else-if="order == 'from_plant' && by == 'desc'"
                                  ...
                                  <th v-else @click="sort('from_plant', 'asc')" class="text-center sortable">
                                    <span class="table_header">Plant Asal</span>
                                    <button>
                                      <span class="sr-only"></span>
                                    </button>
                                  ...
                                  <th v-else @click="sort('to_plant', 'asc')" class="text-center sortable">
                                    <span class="table_header">Plant Tujuan</span>
                                    <button>
                                      <span class="sr-only"></span>
                                    </button>
                              ...
                              <tbody>
                                <tr v-for="(inventory, inventory_index) in inventory_allotment.data"
                                  :key="inventory_index">
                                  <td class="table_content">{{ inventory.id }}</td>
                                  <td class="table_content">{{ inventory.part_number }}</td>
                                  <td class="table_content">{{ inventory.from_plant }}</td>
                                  <td class="text-center table_content">{{ inventory.to_plant }}</td>

          ...
          <div class="col-md-12">
            <div class="card card-plb">
              ...
              <div class="card-body">
                  ...
                  <div class="col-md-6">
                    <form @submit.prevent class="form-horizontal">
                      <div class="form-group row mt-4">
                        <label for="mutation_date" class="col-form-label"
                ...
                <!-- BEGIN: Tampil Data -->
                <div class="form-group mt-4" v-if="date_selected">
                      ...
                      <div class="vgt-global-search vgt-clearfix">
                        <div class="vgt-global-search__input vgt-pull-left">
                          ...
                          <input
                            ...
                            v-model="search_movement_allotments"
                          />
                        </div>
                      </div>
                        ...
                        >
                          <thead>
                            <tr>
                              ...
                              <th
                                colspan="2"
                                v-if="order == 'kno_plus' && by == 'asc'"
                                @click="sort('kno_plus', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                              >
                              ...
                              <th
                                colspan="2"
                                v-else-if="order == 'kno_plus' && by == 'desc'"
                                @click="sort('kno_plus', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                              >
                                <span class="table_header">KNO</span>
                                <button>
                              ...
                              <th
                                colspan="2"
                                v-if="order == 'upg_plus' && by == 'asc'"
                                @click="sort('upg_plus', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                              >
                              ...
                              <th
                                colspan="2"
                                v-else-if="order == 'upg_plus' && by == 'desc'"
                                @click="sort('upg_plus', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                              >
                                <span class="table_header">UPG</span>
                                <button>
                              ...
                              <th
                                colspan="2"
                                v-if="order == 'sub_plus' && by == 'asc'"
                                @click="sort('sub_plus', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                              >
                              ...
                              <th
                                colspan="2"
                                v-else-if="order == 'sub_plus' && by == 'desc'"
                                @click="sort('sub_plus', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                              >
                                <span class="table_header">SUB</span>
                                <button>
                              ...
                              <th
                                colspan="2"
                                v-if="order == 'bpn_plus' && by == 'asc'"
                                @click="sort('bpn_plus', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                              >
                              ...
                              <th
                                colspan="2"
                                v-else-if="order == 'bpn_plus' && by == 'desc'"
                                @click="sort('bpn_plus', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                              >
                                <span class="table_header">BPN</span>
                                <button>
                              ...
                              <th
                                colspan="2"
                                v-if="order == 'dps_plus' && by == 'asc'"
                                @click="sort('dps_plus', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                              >
                              ...
                              <th
                                colspan="2"
                                v-else-if="order == 'dps_plus' && by == 'desc'"
                                @click="sort('dps_plus', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                              >
                                <span class="table_header">DPS</span>
                                <button>
                              ...
                              <th
                                colspan="2"
                                v-if="order == 'cgk_plus' && by == 'asc'"
                                @click="sort('cgk_plus', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                              >
                              ...
                              <th
                                colspan="2"
                                v-else-if="order == 'cgk_plus' && by == 'desc'"
                                @click="sort('cgk_plus', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                              >
                                <span class="table_header">CGK</span>
                                <button>
                              ...
                              <th
                                v-if="
                                  order == 'consumption_install' && by == 'asc'
                                "
                                @click="sort('consumption_install', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                                rowspan="2"
                              >
                                <span class="table_header"
                                  >Consumption/​Install</span
                                >
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th
                                v-else-if="
                                  order == 'consumption_install' && by == 'desc'
                                "
                                @click="sort('consumption_install', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                                rowspan="2"
                              >
                                <span class="table_header"
                              ...
                              <th
                                v-if="
                                  order == 'return_to_plb_gmf' && by == 'asc'
                                "
                                @click="sort('return_to_plb_gmf', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                                rowspan="2"
                              >
                                <span class="table_header"
                                  >Return to PLB GMF</span
                                >
                                <button>
                                  <span class="sr-only"></span>
                                </button>
                              ...
                              <th
                                v-else-if="
                                  order == 'return_to_plb_gmf' && by == 'desc'
                                "
                                @click="sort('return_to_plb_gmf', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                                rowspan="2"
                              >
                                <span class="table_header"
                              ...
                              <!--  -->
                              <th
                                v-if="order == 'last_balance' && by == 'asc'"
                                @click="sort('last_balance', 'desc')"
                                class="text-center sortable sorting sorting-asc"
                                rowspan="2"
                              >
                              ...
                              <th
                                v-else-if="
                                  order == 'last_balance' && by == 'desc'
                                "
                                @click="sort('last_balance', 'asc')"
                                class="text-center sortable sorting sorting-desc"
                                rowspan="2"
                              >
                                <span class="table_header">Saldo Akhir</span>
                          ...
                          <tbody>
                            <tr
                              ...
                              ) in movement_allotment.data"
                              :key="movement_index"
                            >
                              <td class="table_content">{{ movement.osa }}</td>
                              <td class="table_content">
                                {{ movement.first_balance }}
                              </td>
                              ...
                              <td class="text-center table_content">
                                {{ movement.consumption_install }}
                              </td>
                              <td class="text-center table_content">
                                {{ movement.return_to_plb_gmf }}
                              </td>
                              <td class="text-center table_content">
                                {{ movement.last_balance }}
                              </td>
                            </tr>
                      ...
                      <div class="vgt-wrap__footer vgt-clearfix">
                        ...
                        <div class="footer__navigation vgt-pull-right">
                          <button
                            ...
                            @click="
                              movement_allotment.prev_page_url &&
                                list(movement_allotment.prev_page_url)
                            "
                          ...
                          <button
                            ...
                            @click="
                              movement_allotment.next_page_url &&
                                list(movement_allotment.next_page_url)
                            "
                          >
